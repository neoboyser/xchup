CREATOR = "This File Is Made By @xchup" #DON'T CHANGE THIS WARNA ERROR AYEGA 100%
import hashlib
import os
import telebot
import asyncio
...
# Bot token
TOKEN = '8146682887:AAFJtRsooo8Ve4G4L30CmZ-wZMoWvmF_0Cs'
bot = telebot.TeleBot(TOKEN)
REQUEST_INTERVAL = 1

# Admins list
ADMIN_IDS = [1321020431]  # Replace with actual admin user IDs
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴩᴩʀᴏᴠᴇᴅ.ᴩʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ : @xchup ✅*", parse_mode='Markdown')
...
def approve_or_disapprove_user(message):
    ...
    if not is_user_admin(user_id):
        bot.send_message(chat_id, "*ɴᴏᴛ ᴀᴩᴩʀᴏᴠᴇᴅ*", parse_mode='Markdown')
        return
